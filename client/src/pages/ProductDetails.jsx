        ...
        <div className="mt-8 px-4 md:px-0">
            ...
            <div className="flex flex-col md:flex-row gap-12 lg:gap-16">
                ...
                <div className="flex-1 md:w-1/2 lg:pl-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mb-4">
                        {product.stock <= 0 ? (
                            <button disabled className="flex-1 py-4 px-8 rounded-full font-bold bg-gray-100 text-gray-400 border-2 border-gray-200 cursor-not-allowed uppercase tracking-wide flex items-center justify-center gap-2">
                    ...
                    {product.stock > 0 && product.stock < 5 && (
                        <p className="text-orange-600 font-bold text-sm mb-4 bg-orange-50 px-4 py-2 rounded-xl inline-block border border-orange-100">
                            Hurry! Only {product.stock} items left in stock.
                        </p>
                    )}

                    {product.stock <= 0 && (
                        <p className="text-red-600 font-bold text-sm mb-4 bg-red-50 px-4 py-2 rounded-xl inline-block border border-red-100">
            ...
            <div className="mt-24 border-t border-gray-100 pt-16">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
                    {relatedProducts.filter((product) => product.stock > 0 || (product.stock === undefined && product.inStock)).length > 0 ? (
                        relatedProducts.filter((product) => product.stock > 0 || (product.stock === undefined && product.inStock)).map((product, index) => (
